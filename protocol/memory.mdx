...
| Thread event replay | `thread/history`, `thread/timeline/page`, `turn/items`, `turn/work/page`. | Exact durable and semantic timeline data for clients to render or recover UI state. |
