...
Pioneer clients talk to a gateway over JSON-RPC 2.0 on a WebSocket connection. The desktop app, mobile app, shared client core, and any custom client use this contract without linking to gateway internals.
