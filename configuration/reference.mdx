...
These limits help stop runaway loops. Permission modes control whether sensitive tool actions are allowed immediately or require approval. Approved tools still run on the gateway host.
