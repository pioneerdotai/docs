...
This is the full command reference for people who manage a gateway directly. If you normally use the desktop app, start with [CLI Overview](/cli/overview) and return here only when you need a specific command.
