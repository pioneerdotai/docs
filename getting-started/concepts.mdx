...
Artifacts matter because Pioneer may run on a different machine than your desktop. A local file path from your laptop is not useful to a remote gateway. Uploading a file as an artifact gives the gateway a real copy with a stable id, metadata, versions, previews, and download support.
