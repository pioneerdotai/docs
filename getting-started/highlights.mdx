...
Install and manage MCP servers per gateway and current workspace, track their health and catalog, and expose their tools to agents through the gateway.

### Skills

Pioneer supports agentskills-compatible installation, validation, trust gates, dependency preflight, gateway and current workspace availability, upload flow, and health diagnostics.
