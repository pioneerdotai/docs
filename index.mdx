...
If you want the technical version of how Pioneer is built, start with [Architecture Overview](/architecture/overview). The most useful deep dives after this page are [Gateway](/architecture/gateway), [Client Architecture](/architecture/clients), [Agent Loop](/architecture/agent-loop), and [Protocol Layer](/architecture/protocol).
