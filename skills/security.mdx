...
This is why workspace and gateway separation matter. Test unfamiliar skills in a sandbox workspace, and use a sandbox gateway when the skill should not share the same machine, files, or credentials. Do not install random archives directly into your main work workspace.
...
- [Tools Architecture](/architecture/tools) explains the current tool execution model and sandbox limitations.
