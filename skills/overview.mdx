...
<Warning>
  Skill tools run through the gateway and follow the turn permission mode. Test unfamiliar skills in **Supervised** mode first, and use a separate gateway when the skill should not share the same host environment.
</Warning>
...
- [Permission System](/architecture/permissions) explains how turn permission modes apply to dynamic skill tools.
