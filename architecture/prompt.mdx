...
7. Which permission profile was active, and did the model receive a `Current Permissions` section? See [Permission System](/architecture/permissions).
...
- [Permission System](/architecture/permissions) explains the effective profile that produces current permission guidance.
