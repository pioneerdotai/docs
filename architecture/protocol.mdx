...
The protocol includes notifications for thread changes, turn lifecycle, item lifecycle, tool retry and recovery, context compression, skills changes, MCP status/catalog changes, task events, delivery state, and write locks.
...
- [Tasks And Subagents](/architecture/tasks), [MCP Architecture](/architecture/mcp), and [Skills Architecture](/architecture/skills) explain large protocol surfaces.
