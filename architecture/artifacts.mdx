...
The cache key includes workspace, artifact, optional version, provider, optional model family, and transport kind. Expired refs are pruned and ignored. Provider attachment reuse therefore stays workspace scoped and replaces the previous standalone attachment cache.
...
The model can tell that a past message had a photo, PDF, CSV, screenshot, or generated file without loading every old artifact into every turn.
