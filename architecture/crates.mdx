...
| `crates/client` | library | Shared shell-neutral client core: gateway transport, request helpers, notification reducers, read models, selectors, timeline rows, composer workflows, provider/model helpers, skills/MCP/settings/artifact presentation, and schema contracts. |
