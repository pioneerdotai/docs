...
Pioneer is early-stage software. Some protocol and storage shapes are still ahead of every client UI. Workspace creation, switching, and renaming are exposed, but workspace deletion, archival, and cross-workspace thread moves are not part of the current desktop or mobile workflow.
